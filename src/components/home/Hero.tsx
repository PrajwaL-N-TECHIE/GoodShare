        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <RevealOnScroll delay={600}>
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              GoodShare connects donors with NGOs to distribute surplus food, clothes, books and more to those who need it most.
            </p>
          </RevealOnScroll>
          ...
          <RevealOnScroll delay={800}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button size="lg" variant="outline" asChild className="border-white text-white hover:bg-white/10 w-full sm:w-auto transition-all group">
          ...
          {!isMobile && (
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
              <RevealOnScroll delay={1000} direction="up" distance={30}>
                <div className="flex gap-4 py-3 px-6 bg-white rounded-full shadow-lg">
